...
namespace StudioXP.Scripts.Update.Editor
{
    public static class PackageUpdater
    {
        ...
        public static void UpdatePackage()
        {
            ...
            var versionPackageHashFile = $"{packageUpdaterFolder}/{PackagePath.PackageHashFileVersion}";
        ...
        private static void UpdatePackageEnd()
        {
            ...
            File.Delete($"{updaterFolder}/{PackagePath.PackageHashFileVersion}");
            File.Move($"{updaterFolder}/{PackagePath.PackageHashFileRemote}",
                $"{updaterFolder}/{PackagePath.PackageHashFileVersion}");
